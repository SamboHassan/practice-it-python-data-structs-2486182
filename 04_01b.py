"""
CLINING UP DUPLICATE DATA

Default Dict

* Subclass of python dictionary class
* Set default value when a key is not present
* Seprate Nadias dishe's by entree, salad and dessert
